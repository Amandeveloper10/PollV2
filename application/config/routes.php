...
$route['dashboard'] = "dashboard/admin/new_index";
...
$route['check_dept'] = "department/Admin/check_dept";
...
$route['check_designation'] = "designation/Admin/check_designation";
$route['designation_skelitan'] = 'designation/Admin/designation_skelitan';
...
$route['check_grade'] = "grade/Admin/check_grade";
$route['checkminmax_sal'] = "grade/Admin/checkminmax_sal";
...
$route['get_component_type_to_set_formula'] = "salary_component/Admin/get_component_type";
$route['div_colon_set_formula'] = "salary_component/Admin/div_colon";
$route['component_operator'] = "salary_component/Admin/component_operator";
$route['check_component'] = "salary_component/Admin/check_component";
...
$route['admin_get_view_form_salary_structure'] = "salary_structure/Admin/get_form_view";
...
$route['admin_get_salary_structure_view'] = "salary_structure/Admin/get_salary_stucture_view";
...
$route['cron_leave_rules'] = 'leave_rules/Admin/cron_leave_rules';
...
$route['check_policy'] = "insurance_policies/Admin/check_policy";
...
$route['admin_status_admin_settings/(:any)'] = "admin_settings/Admin/status/$1";
// For employees details
$route['employees_details'] = 'employees_details/Admin/index';
$route['employees_details_archive'] = 'employees_details/Admin/get_archive';
...
$route['employees_leave_application_duplicate_date/(:any)/(:any)/(:any)'] = 'employees_details/Admin/employees_leave_application_duplicate_date/$1/$2/$3';
...
$route['admin_get_all_salary_structure'] = "employees_details/Admin/get_all_salary_structure";

$route['admin_get_net_salary_div_edit'] = "employees_details/Admin/get_net_salary_div_edit";
$route['admin_get_net_salary_div_view'] = "employees_details/Admin/get_net_salary_div_view";
...
$route['check_rf_no'] = "employees_details/Admin/check_rf_no";
$route['div_colon_for_opening_balance'] = "employees_details/Admin/div_colon";

$route['add_work_experience'] = "employees_details/Admin/add_work_experience";
$route['delete_experience'] = "employees_details/Admin/delete_experience";

$route['add_education'] = "employees_details/Admin/add_education";
$route['delete_education'] = "employees_details/Admin/delete_education";

$route['upload_emp_csv'] = 'employees_details/Admin/upload_excel';
$route['employeecsv'] = "employees_details/Admin/uploadData";

/******** 12.03.19 **/
// For attendance
$route['attendance'] = 'attendance/Admin/index';
$route['search_attendance'] = 'attendance/Admin/search_attendance';
...
$route['admin_addedit_attendance_from_dashboard'] = 'attendance/Admin/form_dashboard';
$route['admin_break_in_attendance_from_dashboard'] = 'attendance/Admin/form_dashboard_break_in';
$route['admin_break_out_attendance_from_dashboard'] = 'attendance/Admin/form_dashboard_break_out';
/*** 23.03.19 **/
// For overtime_name
...
$route['check_overtime'] = "overtime_rules/Admin/check_overtime";

/**** 28.03.19 **/
// payroll
$route['payroll'] = 'payroll/Admin/index';
$route['payroll_details/(:any)'] = 'payroll/Admin/index_payroll/$1';
$route['payroll_register/(:any)'] = 'payroll/Admin/index_payroll_register/$1';

$route['off_cycle'] = 'payroll/Admin/off_cycle';
$route['off_cycle_details/(:any)'] = 'payroll/Admin/off_cycle_details/$1';
//$route['off_cycle_details'] = 'payroll/Admin/off_cycle_details';

$route['off_cycle/(:any)'] = 'payroll/Admin/off_cycle/$1';
$route['admin_get_form_off_cycle'] = "payroll/Admin/get_form";
$route['admin_edit_off_cycle'] = "payroll/Admin/admin_edit_off_cycle";
$route['final_submission_off_cycle'] = "payroll/Admin/final_submission_off_cycle";
$route['off_payroll_list'] = 'payroll/Admin/off_payroll_list';
...
$route['employee_Payable_payroll'] = 'payroll/Admin/employee_Payable';
$route['employee_AdhokPay_payroll'] = 'payroll/Admin/employee_AdhokPay';
$route['employee_Hold_payroll'] = 'payroll/Admin/employee_Hold';
$route['employee_Register_payroll'] = 'payroll/Admin/employee_Register';
$route['employee_Register_payroll_view'] = 'payroll/Admin/employee_Register_view';
...
$route['download_salary_slip_payroll'] = "payroll/Admin/download_salary_slip_payroll";
$route['down_slip/(:any)/(:any)/(:any)'] = "payroll/Admin/down_slip/$1/$2/$3";
$route['down_slip_final/(:any)/(:any)/(:any)'] = "payroll/Admin/down_slip_final/$1/$2/$3";
$route['send_salary_slip'] = "payroll/Admin/send_salary_slip";
$route['add_adhob_div'] = "payroll/Admin/add_adhob_div";
$route['getallcomponent'] = "payroll/Admin/getallcomponent";
$route['save_freeze_month_leaves'] = "payroll/Admin/save_freeze_month_leaves";
$route['save_freeze_month_payroll'] = "payroll/Admin/save_freeze_month_payroll";
$route['emp_register_delete'] = "payroll/Admin/emp_register_delete";

$route['getallcomponentfor_offcycle'] = "payroll/Admin/getallcomponentoffcycle";

$route['add_off_cycle_pay'] = "payroll/Admin/add_off_cycle_pay";
$route['admin_add_offcycle'] = 'payroll/Admin/form';
$route['admin_edit_offcycle/(:any)'] = "payroll/Admin/form/$1";
$route['download_off_cycle_payroll'] = "payroll/Admin/download_off_cycle_payroll";
$route['checkcomponent_offcycle'] = "payroll/Admin/checkcomponent_offcycle";
$route['checkcomponent_offcycle_deduction'] = "payroll/Admin/checkcomponent_offcycle_deduction";
...
$route['search_leave'] = 'employee_leave/Admin/search_leave';
...
$route['admin_get_view_form_employee_leave'] = "employee_leave/Admin/get_form_view";
$route['admin_get_employee_leave'] = "employee_leave/Admin/get_employee_leave";
$route['check_unapproved_leaves_of_employee'] = "employee_leave/Admin/check_unapproved_leaves_of_employee";
$route['employees_leave_approval_status/(:any)/(:any)/(:any)/(:any)'] = "employee_leave/Admin/approval_status/$1/$2/$3/$4";
$route['employees_leave_approval_status_check/(:any)/(:any)/(:any)'] = "employee_leave/Admin/approval_status_check/$1/$2/$3";
...
$route['admin_get_edit_form_employee_opening'] = "employee_leave/Admin/get_opening_form";
$route['admin_get_employee_opening_leave'] = "employee_leave/Admin/get_employee_leave";
$route['delete_selected_image'] = 'employee_leave/Admin/delselected_image';


//Dashboard Module
$route['dashboard'] = 'dashboard/Admin/index';
$route['dashboard/(:any)'] = "dashboard/Admin/index/$1"; // used to load only middle content
$route['get_leave_in_dashbord'] = 'dashboard/Admin/get_leave_in_dashbord';
$route['get_attendance_in_dashbord'] = 'dashboard/Admin/get_attendance_in_dashbord';
...
$route['template_choose'] = 'employees_details/Admin/template_choose';
$route['template_genarate'] = 'employees_details/Admin/template_genarate';
$route['downtemplate/(:any)/(:any)'] = "employees_details/Admin/down_slip/$1/$2";
$route['sendemail/(:any)/(:any)'] = "employees_details/Admin/send_email/$1/$2";
$route['upload_crop_image'] = 'employees_details/Admin/upload_crop_image';
$route['upload_voter_crop_image'] = 'employees_details/Admin/upload_voter_crop_image';
$route['upload_pan_crop_image'] = 'employees_details/Admin/upload_pan_crop_image';
$route['upload_aadhar_crop_image'] = 'employees_details/Admin/upload_aadhar_crop_image';
...
$route['check_equipment'] = 'assigned_employee/Admin/check_equipment';
...
$route['check_state'] = "Ptax/Admin/check_state";
...
$route['check_lop_grade'] = "lop/Admin/check_lop_grade";
...
// For Time Off
$route['timeoff'] = 'timeoff/Admin/index';
$route['timeoff/(:any)'] = "timeoff/Admin/index/$1"; // used to load only middle content
//$route['timeoff/(:any)/(:any)'] = "timeoff/Admin/index/$1/$2"; // used to load only middle content 
$route['admin_add_timeoff'] = 'timeoff/Admin/form';
$route['admin_edit_timeoff/(:any)'] = "timeoff/Admin/form/$1";
$route['admin_get_edit_form_timeoff'] = "timeoff/Admin/get_form";
$route['admin_status_timeoff/(:any)'] = "timeoff/Admin/status/$1";
$route['admin_delete_timeoff/(:any)'] = "timeoff/Admin/delete/$1";
$route['employees_timeoff_approval_status/(:any)/(:any)/(:any)/(:any)'] = "timeoff/Admin/approval_status/$1/$2/$3/$4";
$route['getallemployee'] = 'timeoff/Admin/getallemployee';
$route['admin_get_view_form_timeoff'] = "timeoff/Admin/get_form_view";


// For wfh rules
$route['wfh'] = 'wfh/Admin/index';
$route['wfh/(:any)'] = "wfh/Admin/index/$1"; // used to load only middle content 
$route['admin_add_wfh'] = 'wfh/Admin/form';
$route['admin_edit_wfh/(:any)'] = "wfh/Admin/form/$1";
$route['admin_get_edit_form_wfh'] = "wfh/Admin/get_form";
$route['admin_status_wfh/(:any)'] = "wfh/Admin/status/$1";
$route['admin_delete_wfh/(:any)'] = "wfh/Admin/delete/$1";


$route['employee_attendance'] = 'employee_attendance/Admin/index';
$route['employee_attendance/(:any)'] = "employee_attendance/Admin/index/$1";
$route['admin_employee_att_report'] = "employee_attendance/Admin/admin_employee_att_report";


// For employee_opening_leave
$route['employee_opening_leave'] = 'employee_opening_leave/Admin/index';
$route['employee_opening_leave/(:any)'] = "employee_opening_leave/Admin/index/$1"; // used to load only middle content 
$route['admin_add_employee_opening_leave'] = 'employee_opening_leave/Admin/form';
$route['admin_edit_employee_opening_leave/(:any)'] = "employee_opening_leave/Admin/form/$1";
$route['admin_get_edit_form_employee_opening_leave'] = "employee_opening_leave/Admin/get_opening_form";
$route['admin_get_employee_opening_leave'] = "employee_opening_leave/Admin/get_employee_leave";
$route['admin_get_all_leaves'] = "employee_opening_leave/Admin/get_all_leaves";
$route['admin_check_emp_openingbalance'] = "employee_opening_leave/Admin/check_emp_opening";

$route['leavedata'] = "employee_opening_leave/Admin/leavedata";
$route['leavedata_details'] = "employee_opening_leave/Admin/leavedata_details";

$route['admin_employee_opening_leave_monthwise'] = 'employee_opening_leave/Admin/admin_employee_opening_leave_monthwise';

$route['summary_report'] = 'summary_report/Admin/index';
$route['summary_report/(:any)'] = "summary_report/Admin/index/$1";
$route['admin_employee_report'] = "summary_report/Admin/admin_employee_report";



// For templates
$route['templates'] = 'templates/Admin/index';
$route['templates/(:any)'] = "templates/Admin/index/$1"; // used to load only middle content 
$route['admin_add_templates'] = 'templates/Admin/form';
$route['admin_edit_templates/(:any)'] = "templates/Admin/form/$1";
$route['admin_get_edit_form_templates'] = "templates/Admin/get_form";
$route['admin_status_templates/(:any)'] = "templates/Admin/status/$1";
$route['admin_delete_templates/(:any)'] = "templates/Admin/delete/$1";
$route['check_templates'] = "templates/Admin/check_templates";
