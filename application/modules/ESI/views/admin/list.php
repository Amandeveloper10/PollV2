...
<div class="ks-page-header">
	...
	<h3><span>Settings > HR Master ></span> ESI</h3>
            ...
            <table id="payrolltable" class="table table-list">
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td><?php echo $data->employee_esi_account_no; ?></td>
                    <td><?php echo $data->employer_esi_percent; ?></td>
                    <td><?php echo $data->employee_esi_percent; ?></td>
