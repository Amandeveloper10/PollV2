<form onsubmit="return myFunction('benefits_LTC')" method="post" action="<?php echo (isset($id) && $id != '') ? base_url('admin_edit_benefits_LTC').'/'.$id : base_url('admin_add_benefits_LTC'); ?>" name="benefits_LTC" id="benefits_LTC" enctype="multipart/form-data" >
<div class="row">
    <div class="col-md-3">
