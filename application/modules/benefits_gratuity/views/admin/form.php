<form onsubmit="return myFunction('benefits_gratuity')" method="post" action="<?php echo (isset($id) && $id != '') ? base_url('admin_edit_benefits_gratuity').'/'.$id : base_url('admin_add_benefits_gratuity'); ?>" name="benefits_gratuity" id="benefits_gratuity" enctype="multipart/form-data" >
<div class="row">
    <div class="col-md-3">
