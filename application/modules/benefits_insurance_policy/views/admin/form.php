<form onsubmit="return myFunction('benefits_insurance_policy_form')" method="post" action="<?php echo (isset($id) && $id != '') ? base_url('admin_edit_benefits_insurance_policy').'/'.$id : base_url('admin_add_benefits_insurance_policy'); ?>" name="benefits_insurance_policy_form" id="benefits_insurance_policy_form" enctype="multipart/form-data" >
<div class="row">
    <div class="col-md-3">
