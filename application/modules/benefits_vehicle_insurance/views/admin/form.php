<form onsubmit="return myFunction('benefits_vehicle_insurance')" method="post" action="<?php echo (isset($id) && $id != '') ? base_url('admin_edit_benefits_vehicle_insurance').'/'.$id : base_url('admin_add_benefits_vehicle_insurance'); ?>" name="benefits_vehicle_insurance" id="benefits_vehicle_insurance" enctype="multipart/form-data" >
<div class="row">
    <div class="col-md-3">
