<form onsubmit="return myFunction('benefits_vehicles')" method="post" action="<?php echo (isset($id) && $id != '') ? base_url('admin_edit_benefits_vehicles').'/'.$id : base_url('admin_add_benefits_vehicles'); ?>" name="benefits_vehicles" id="benefits_vehicles" enctype="multipart/form-data" >
<div class="row">
    <div class="col-md-3">
