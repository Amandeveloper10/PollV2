<form onsubmit="return myFunction('benefits_workman_compensation_form')" method="post" action="<?php echo (isset($id) && $id != '') ? base_url('admin_edit_benefits_workman_compensation').'/'.$id : base_url('admin_add_benefits_workman_compensation'); ?>" name="benefits_workman_compensation_form" id="benefits_workman_compensation_form" enctype="multipart/form-data" >
<div class="row">
    <div class="col-md-3">
