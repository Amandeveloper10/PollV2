<div class="ks-page-header">
    <section class="ks-title">
        <h3> <span>HR</span> Certificate</h3>
            ...
            <table id="payrolltable" class="table table-list">
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td><?php echo $data->delete_flag; ?></td>
...
function btnCloseForm(){
    ...
    function openForm(id){
         $.post("<?php echo base_url('admin_get_edit_form_certificate'); ?>", {id: id}, function(result){
            //console.log(result);
    ...
    function change_status(id) {
        $("#myModal").on('shown.bs.modal', function() {
            $("#modal_confirm").click(function() {
                var url = "<?php echo base_url('admin_status_certificate'); ?>/" + id;
            ...
            $("#notification_body").html("Do you want to change status of this certificate?");
        }).modal("show");
    }
     ...
     function delete_this(id) {
        $("#myModal").on('shown.bs.modal', function() {
            $("#modal_confirm").click(function() {
               var url = "<?php echo base_url('admin_delete_certificate'); ?>/" + id;
                $("#pjax-container").load(url,function(response,status){
                    notification(status);
                });
            });
            ...
            $("#notification_heading").html("Confirmation");
            $("#notification_body").html("Do you want to Delete this certificate?");
        }).modal("show");
    }
</script>
