                                    ...
                                    if(!empty($upcoming_bday)){
                                        ...
                                        <table class="table small-card">
                                            <tr>
                                                ...
                                                <td>
                                                    <h5><a class="pjaxCls" href="<?php echo base_url('page/64/' . base64_encode(@$bday->id)); ?>"><?php echo @$bday->first_name . ' ' . @$bday->middle_name . ' ' . @$bday->last_name; ?></a></h5>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table small-card">
                                            <tr>
                                                ...
                                                <td>
                                                    <h5><a class="pjaxCls" href="<?php echo base_url('page/64/' . base64_encode(@$anniversary->id)); ?>"><?php echo @$anniversary->first_name . ' ' . @$anniversary->middle_name . ' ' . @$anniversary->last_name; ?></a></h5>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table small-card">
                                    <tr>
                                        ...
                                        <td>
                                            <h5><a class="pjaxCls" href="<?php echo base_url('page/64/' . base64_encode(@$joining->id)); ?>"><?php echo @$joining->first_name . ' ' . @$joining->middle_name . ' ' . @$joining->last_name; ?></a></h5>
...
<script>
	...
	function approve_status(id,status,employee_id){            
			...
			function addattendance(employee_id,datetime){
				...
				$.post("<?php echo base_url('admin_addedit_attendance_from_dashboard'); ?>", {'employee_id': employee_id, 'datetime': datetime}, function (result) {
					//console.log(result);
			...
			function breakin(attendance_id,employee_id,datetime){
				...
				$.post("<?php echo base_url('admin_break_in_attendance_from_dashboard'); ?>", {'attendance_id':attendance_id,'employee_id': employee_id, 'datetime': datetime}, function (result) {
					//console.log(result);
					$.post("<?php echo base_url('get_attendance_in_dashbord'); ?>", {'employee_id': employee_id}, function(result){
								//console.log(result);
								$("#attendanceDiv").html(result);
			...
			function breakout(id,attendance_id,employee_id,datetime,entry_time){
				...
				$.post("<?php echo base_url('admin_break_out_attendance_from_dashboard'); ?>", {'id':id,'attendance_id':attendance_id,'employee_id': employee_id, 'datetime': datetime,'entry_time':entry_time}, function (result) {
					//console.log(result);
					$.post("<?php echo base_url('get_attendance_in_dashbord'); ?>", {'employee_id': employee_id}, function(result){
								//console.log(result);
								$("#attendanceDiv").html(result);
