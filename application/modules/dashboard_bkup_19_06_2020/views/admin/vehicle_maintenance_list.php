        ...
        <div class="ks-nav-body">
            <div class="ks-user-list-view-header-block">
                <h4 class="ks-user-list-view-header-block-name">
                    <span class="d-none d-sm-block">Vehicles Maintenance List</span>
...
<!--                        <span>50 vehicles</span>-->
                ...
                <div class="ks-user-list-view-header-control">
                    <a href="javascript:void(0)" class="btn btn-primary btn-add-vehicle" onclick="openForm('');">Add New Maintenance</a>
                </div>
            </div>
