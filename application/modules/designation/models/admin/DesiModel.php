...
class DesiModel extends CI_Model {
    ...
    public function load_all_data() {
        $this->db->select('t1.*');
        $this->db->from(tablename('master_designation') . ' as t1');
	 ...
	 public function load_all_data_limit($limit) {
        $this->db->select('t1.*');
        $this->db->from(tablename('master_designation') . ' as t1');
        $this->db->where('t1.delete_flag', 'N'); 
		$this->db->limit($limit);
 ...
 /**
    ...
    public function delete_this($id) {
      ...
      public function check_designation($desg = "",$id = "") {
        $this->db->select('t1.*'); 
        $this->db->from(tablename('master_designation') . ' as t1');
        $this->db->where('t1.delete_flag', 'N');
        $this->db->where('t1.is_active', 'Y');
        $this->db->where('t1.designation_name', $desg);
