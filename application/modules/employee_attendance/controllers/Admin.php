...
class Admin extends MX_Controller {
    ...
    public function admin_employee_att_report(){
        ...
        $this->data['month_id'] = $month_id;
         $offshift = $this->EmpattModel->get_result_data('master_work_shift_off_day',array('work_shift_id'=>$this->data['data_single']->work_shift_id,'weekvalue'=>'Full'));
            $offSHIFTarr = array();
			...
			$this->data['employee'] = $_POST['employee'];
      ...
      public function admin_employee_report(){
        $month= $_POST['month'];
        $this->data['all_employee'] = $this->EmpattModel->load_all_employee();
         $this->data['all_leave_type'] = $this->EmpattModel->get_result_data('master_leave_rules',array('delete_flag'=>'N','is_active'=>'Y'));
        $this->data['month'] = $month;
      $view = $this->load->view('employee_attendance/admin/report_ajax', $this->data, TRUE);
     echo $view;
        exit();
    }
