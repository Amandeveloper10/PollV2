...
<!--                    <th></th>                               -->
                ...
                <?php
                   ...
                   // echo '<pre>';print_r($all_data);exit;
                    if (!empty($all_data)) {
                      foreach ($all_data['employee_name'] as $key => $data) {
                    ?>
                  <tr>
                    <td><?php echo @$data; ?></td>
                    <td><?php echo @$all_data['joining'][$key]; ?></td>
                     <td><?php echo @$all_data['working_year'][$key]; ?></td>
                    <td class="text-right"><?php echo number_format(@$all_data['amount'][$key],2); ?></td>
