...
<?php $url = (isset($id) && $id != '') ? base_url('admin_edit_employee_leave').'/'.$id : base_url('admin_add_employee_leave');?>
	...
	<input type="hidden" id="edit_id" value="<?php echo (isset($id) && $id != '' ? $id : ''); ?>">
...
if($ext=='jpg' || $ext=='jpeg' || $ext=='png' || $ext=='bmp' || $ext=='gif')
{
                                                           ...
                                                           <strong> <div id="remove<?php echo $a;?><?php echo @$data_single->id;?>"> <?php echo $a++; ?>)</strong> <img id="myImg1<?php echo $a;?>" src="<?php if(!empty($value)) { echo base_url(); ?>uploads/<?php echo @$value; } ?>" onclick="call_lightbox_Employment(<?php echo $a;?>);" alt="" class="img-fluid myImg">
                                                          <?php if(!empty($value)) { ?>
                                                          <a href="<?php echo base_url('employees_loanapplication_download/').@$value; ?>"><span class="la la-arrow-circle-down" style="font-size: 50px;"></span></a>
                                                          <?php } ?>

                                                          <?php  if(!empty($value)) { ?>
                                                            <a href="#" onclick="deleteimg('<?php echo @$data_single->id; ?>','<?php echo @$value?>','employee_leave_application','<?php echo $a-1;?>','','documents');" title="Delete"> <span class="la la-close" style="font-size: 20px;"></span></a>
                                                            <?php } ?>
                                                          </div><br>
                                                           <?php
}
    ...
    ?>
                                                   ...
                                                   <strong>     <div id="remove<?php echo $a;?><?php echo @$data_single->id;?>"><?php echo $a++; ?>)  </strong>   <a href="<?php echo base_url('employees_loanapplication_download/').@$value; ?>"> <?php echo @$value; ?> </a>
                                                      <?php  if(!empty($value)) { ?>
                                                            <a href="#" onclick="deleteimg('<?php echo @$data_single->id; ?>','<?php echo @$value?>','employee_leave_application','<?php echo $a-1;?>','','documents');" title="Delete"> <span class="la la-close" style="font-size: 20px;"></span></a>
                                                            <?php } ?>
                                                          </div>
