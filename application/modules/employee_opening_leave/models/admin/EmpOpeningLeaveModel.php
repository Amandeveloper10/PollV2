...
class EmpOpeningLeaveModel extends CI_Model {
    ...
    public function load_all_data() {
        $this->db->select('t1.*,t2.employee_no,t2.id as empid,t2.first_name,t2.last_name,t2.middle_name,t2.grade,t3.rule_name,t2.personal_image');
      ...
      public function load_all_data_monthwise($month) {
        $this->db->select('t1.*,t2.employee_no,t2.first_name,t2.last_name,t2.middle_name,t3.rule_name');
        $this->db->from(tablename('employee_leaves'). ' as t1');
        $this->db->join('employee as t2', 't2.id = t1.employee_id', 'left');
        $this->db->join('master_leave_rules as t3', 't3.id = t1.leave_id', 'left');
    ...
    public function get_result_data($table, $where = "1=1") {
	 ...
	 public function get_result_data_order_by($table, $where = "1=1") {
