    ...
    <div class="row" style="margin-bottom: 0 !important">
        <div class="col-sm-6 col-xl-3">
            <div class="form-group">
                ...
                <input required type="text" placeholder="Enter Date" class="form-control flatpickrDateNew" name="date" id="date" value="<?php echo (isset($data_single->date) ? $data_single->date : ''); ?>">
            </div>
        </div>
    <div class="col-md-3">
    <div class="form-group">
        <label>Employee No</label>
            <select id="employee_id" name="employee_id" class="form-control" required="required" onchange="getallleaves(),checkOpening();">
