...
<style type="text/css">
     td.details-control {
            background: url('/sketchpayroll/assets/images/details_open.png') no-repeat center center;
            cursor: pointer;
        }
        tr.shown td.details-control {
            background: url('/sketchpayroll/assets/images/details_close.png') no-repeat center center;
        }
 </style>
...
function format ( d ) {
	...
	//console.log(d);
	var obj = d.leave;
	 $.post("<?php echo base_url('leavedata_details'); ?>", {'obj': obj}, function(result){
            //console.log(result);
			//return '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">'"+result+'</table>';
			//return('++d.open+');
			//return result;
	...
	$.each( obj, function( key, value ) {
	  ...
	  var value = jQuery.parseJSON(JSON.stringify(value));
	  var leaveType = value.Full name;
	  var open = value.open;
	  var credit = value.credit;
	  var take = value.take;
	 // return'<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;"><tbody>'+'<tr>'+'<td>'+leaveType+'</td>'+'<td>'+open+'</td>'+'</tr>'+'</tbody></table>';
	  var html = '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">';
