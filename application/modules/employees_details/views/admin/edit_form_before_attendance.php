...
<div class="ks-info mt-0">
    ...
    <div class="ks-description"><?php echo @$data_single->designation; ?></div>
                    ...
                    <div class="row mt-2">
                        <div class="col-sm-6 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter telephone number" class="form-control inputDisabled" value="<?php echo @$data_single->contact_city; ?>" name='contact_phone'  id='contact_phone'>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4">
                            <div class="form-group">
...
<!--                        <a href="#" class="btn btn-outline-primary ks-light ks-no-text edit-profile-btn"><span class="la la-pencil ks-icon"></span></a>-->
                    ...
                    <div class="card-block">
                        ...
                        <div class="mt-5">
                            ...
                            <a href="javascript:void(0);" onclick="openaddform();" type="btn" class="btn btn-outline-primary mt-4 btn-add-leave btnDisabled">Add Leave Application</a>
<!--                            <a href="javascript:void(0);" type="btn" class="btn btn-outline-primary mt-4 ml-3 btn-add-leave-settlement disabled btnDisabled">Add Leave Settlement</a>-->

                            <div class="card panel panel-default add-leave mt-4" id="leave_application_form_div" style="display: none;">
                                <h5 class="card-header" style="font-size: 13px;">
                                    Add Leave
                                </h5>
                                <?php
...
<!--                            <button type="reset" class="btn btn-outline-secondary ks-light reset-profile-btn" style="display: none;">Reset</button>-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="ks-user-list-view-table">
                                <div  class="ks-full-table table-responsive">
