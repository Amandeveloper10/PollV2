<div class="row mt-2">
                        <div class="col-sm-6 col-xl-4">
                            <div class="form-group">
                                ...
                                <select id="salary_structure1" name="salary_structure" class="form-control">
                                <option>Select</option>
                                <?php
                                  if (!empty($all_salary_structure)) {
                                    foreach ($all_salary_structure as $salary_structure) {
                                  ?>
                                  <option value="<?php echo $salary_structure->id; ?>" <?php echo ((isset($salary_structure_val) && ($salary_structure_val==$salary_structure->id)) ? 'selected' : ''); ?>><?php echo $salary_structure->structure_name; ?></option>
                                  <?php } } ?>
                            </select>
                            </div>
                        ...
                        <div class="col-sm-6 col-xl-4">
                            <div class="form-group">
                                ...
                                <input onkeyup="numeric(this);checkCTCgrade('<?php echo @$minSalary; ?>','<?php echo @$maxSalary; ?>',this);getsalarystructure(this.val);" type="text" placeholder="Enter CTC" class="form-control inputDisabled ctcAmtClass" name='ctc' id='ctc1' value="<?php echo @$data_single->ctc_amount; ?>" > 
                           ...
                           <!-- <span style="color: red;">** <small>CTC will be between <?php echo @$minSalary; ?> - <?php echo @$maxSalary; ?> according to Grade <?php echo (!empty($getMinMaxSalary)) ? $getMinMaxSalary->grade_name : '' ?></small></span>
                            ...
                            <input type="hidden" name="edit_id" id="edit_id1" value="<?=$data_single->id?>">
                            </div>
                        </div>
                    </div>    
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input style="text-align: right;" type="text" class="form-control inputDisabled yearlySalaryClass yearlyamount yearly_<?php echo $component_Earning->id; ?>" data-id="<?php echo $component_Earning->id; ?>" value="<?php echo number_format(round($amt1),2,'.', ''); ?>" disabled="disabled"></td>
                                                    <?php }else{ ?>
                                                    <td>
                                                    <input onkeypress="isNumberKey(event,this.value);" onkeyup="calculateSalaryEdit(),calculateAmoutEdit('<?php echo $component_Earning->id; ?>');" style="text-align: right;" type="text" data-id="<?php echo $component_Earning->id; ?>"  class="form-control fixedamount yearlySalaryClass yearlyamount yearly_<?php echo $component_Earning->id; ?>" value="<?php echo number_format(round($amt1),2,'.', ''); ?>"></td>
                                                    <?php  } ?>
                                            </tr>
                                        <?php }} ?>  
...
<?php 
                                            ...
                                            if(!empty($PF)){
                                                    ...
                                                    $net_amt2 += $data_single->employeemothlypf;
                                                    $net_amt21 += $data_single->employeeyearlypf;
                                            ...
                                            <tr>
                                                ...
                                                <td>PF (Employee Contribution <?=$employee_pf_percent.'%'?>)<?php if($choiceofpf == 'Y'){ ?><input type="checkbox" name="pf_show_checkbox" id="pfcheck" onclick="calculateSalaryEdit();" value="1" checked="checked" ><?php } else{ ?><input type="checkbox" name="pf_show_checkbox" id="pfcheck" disabled="" value="1" checked="checked" ><?php } ?>
                                                ...
                                                <td><input style="text-align: right;" type="text" class="form-control" id="employeemothlypf" name="employeemothlypf" onkeyup="calculatepfAmout();" <?php if($pfAmountatjust == 'N'){ echo 'disabled';}else{ echo '';}?> value="<?php echo number_format(round($data_single->employeemothlypf),2,'.', ''); ?>"></td>

                                                <td><input style="text-align: right;" type="text" class="form-control inputDisabled totaldeductions" id="employeeyearlypf"  name="employeeyearlypf" onkeyup="calculatepf();" readonly="readonly" value="<?php echo number_format(round($data_single->employeeyearlypf),2,'.', ''); ?>">
                                                    <input style="text-align: right;" type="hidden" class="form-control inputDisabled" id="employeeyearlypfhidden" value="<?php echo number_format(round($data_single->employeeyearlypf),2,'.', ''); ?>">
                                                </td>
                                        ...
                                        <?php } } ?>
                                         ...
                                         <?php 
                                            ...
                                            if(!empty($ESI)){
                                                ...
                                                $net_amt2 += $data_single->employeemothlyesi;
                                                $net_amt21 += $data_single->employeeyearlyesi;
                                                if($data_single->esi != '0'){
                                                ?>

                                            <tr>

                                                <td>ESI (Employee Contribution <?=$employee_esi_percent.'%'?>)<?php if($checkedesi == 'Y'){ ?><input type="checkbox" name="esi_show_checkbox" id="esicheck" onclick="calculateSalaryEdit();" value="1" checked="checked" ><?php } else{ ?><input type="checkbox" name="esi_show_checkbox" id="esicheck" disabled="" value="1" checked="checked" ><?php } ?>
                                                ...
                                                <td><input style="text-align: right;" type="text" class="form-control inputDisabled " id="employeemothlyesi" name="employeemothlyesi"  value="<?php echo number_format(round($data_single->employeemothlyesi),2,'.', ''); ?>" readonly="readonly"></td>

                                                <td><input style="text-align: right;" type="text" class="form-control inputDisabled totaldeductions" id="employeeyearlyesi" name="employeeyearlyesi" value="<?php echo number_format(round($data_single->employeeyearlyesi),2,'.', ''); ?>" readonly="readonly">

                                                     <input style="text-align: right;" type="hidden" class="form-control inputDisabled" id="employeeyearlyesihidden" value="<?php echo number_format(round($data_single->employeeyearlyesi),2,'.', ''); ?>">
                                                </td>
                                            </tr>
                                        <?php } } ?>
                                        ...
                                        $net_amt21 += $yearly_ptax;
                                            ...
                                            <tr>
                                                ...
                                                <td>Ptax <input type="hidden" id="ptaxcheck" onclick="calculateSalaryEdit();"  name="ptax_show_checkbox" value="1" >
...
<?php 
                                            ...
                                            if(!empty($PF)){
                                                    ...
                                                    $net_amt3 += $data_single->employermothlypf;
                                                    $net_amt31 += $data_single->employeryearlypf;
                                            ...
                                            <tr>
                                                ...
                                                <td><input style="text-align: right;" type="text" class="form-control inputDisabled totalbenefitmonthly" id="employermothlypf" name="employermothlypf" onkeyup="calculatepf();" readonly="readonly" value="<?php echo number_format(round($data_single->employermothlypf),2,'.', ''); ?>"></td>

                                                <td><input style="text-align: right;" type="text" class="form-control inputDisabled totalbenefityearly" id="employeryearlypf" name="employeryearlypf" onkeyup="calculatepf();" readonly="readonly" value="<?php echo number_format(round($data_single->employeryearlypf),2,'.', ''); ?>">
                                                    <input style="text-align: right;" type="hidden" class="form-control inputDisabled" id="employeryearlypfhidden" value="<?php echo number_format(round($data_single->employeryearlypf),2,'.', ''); ?>">
                                                </td>
                                         ...
                                         <?php 
                                            $ESI = $this->EmployeesModel->check_esi_exist($master_salary_structureid);
                                             if(!empty($ESI)){
                                                ...
                                                $net_amt3 += $data_single->employermothlyesi;
                                                $net_amt31 += $data_single->employeryearlyesi;
                                                 if($data_single->esi != '0'){
                                                ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><input style="text-align: right;" type="text" class="form-control inputDisabled totalbenefitmonthly" id="employermothlyesi" name="employermothlyesi"  value="<?php echo number_format(round($data_single->employermothlyesi),2,'.', ''); ?>" readonly="readonly"></td>

                                                <td><input style="text-align: right;" type="text" class="form-control inputDisabled totalbenefityearly" id="employeryearlyesi" name="employeryearlyesi" value="<?php echo number_format(round($data_single->employeryearlyesi),2,'.', ''); ?>" readonly="readonly">
                                                     <input style="text-align: right;" type="hidden" class="form-control inputDisabled" id="employeryearlyesihidden" value="<?php echo number_format(round($data_single->employeryearlyesi),2,'.', ''); ?>">
                                                </td>
                                            </tr>
                                        <?php } }  ?>
                                         <?php
                ...
                <div class="row">
                        <div class="col-xl-4">
                            <div class="form-group">
                               ...
                               <input class="form-control mysingle_date" id="application_date" name="application_date" type="text" value="<?php echo date('d-m-Y',strtotime(@$data_single->application_date));?>" placeholder="Select Date..">
                            </div>
                        </div>
                        <div class="col-xl-12">                            
                                <label for="" class="form-control-label">Note</label>
                                <textarea placeholder="Enter note" class="form-control inputDisabled" name='note'  id='note1' rows="4"><?php echo @$data_single->note;?></textarea>                            
                        </div> 

                        <div class="col-xl-12">                            
                            <button style="float:right;" type="button" class="btn btn-primary saveSalary" onclick="updateSalaryStructure('<?php echo @$data_single->employee_id; ?>');">Update</button>                            
                        </div> 
