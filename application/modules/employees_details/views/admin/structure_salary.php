...
<?php 
                                            ...
                                            <tr>
                                                ...
                                                <td><input style="text-align: right;" type="text" class="form-control" id="employeemothlypf" name="employeemothlypf" onkeyup="calculatepfAmout();" <?php if($pfAmountatjust == 'N'){ echo 'disabled';}else{ echo '';}?> value="<?php echo number_format(round($pf_monthly_house_rent),2,'.', ''); ?>"></td>
                ...
                <div class="row">
                        <div class="col-xl-4">
                            <div class="form-group">
                               ...
                               <input class="form-control mysingle_date flatpickrDate" id="application_date" name="application_date" type="text" placeholder="Select Date..">
                            </div>
                        </div>
                        <div class="col-xl-12">                            
                         ...
                         <div class="col-xl-12">                            
                            <button style="float:right;" type="button" class="btn btn-primary saveSalary" onclick="salarydivopen();">Update</button>                            
                        </div> 
