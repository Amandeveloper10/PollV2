            ...
            <div class="tab-pane fade p-0 active show" id="pills-general" role="tabpanel" aria-labelledby="pills-general-tab">  
                ...
                <div class="row">
                 ...
                 <div class="accordion" id="accordionExample">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse fade show" aria-labelledby="headingOne" data-parent="#accordionExample">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse fade show" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body  pb-0">
                                 <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseFour" class="collapse fade show" aria-labelledby="headingFour" data-parent="#accordionExample">
                            <div class="card-body">
                                <div class="row">
                          <div class="col-sm-6 col-xl-4">
                            <div class="form-group">
                    ...
                    <div class="col-sm-6 col-xl-4">
                     ...
                     <div class="card">
                        ...
                        <div id="collapseFive" class="collapse fade show" aria-labelledby="headingFive" data-parent="#accordionExample">
                            <div class="card-body">
                                <div class="row">
                   ...
                   <div class="col-xl-12" id="experience_div" >
                    ...
                    <div class="card">
                        ...
                        <div id="collapseSix" class="collapse fade show" aria-labelledby="headingSix" data-parent="#accordionExample">
                            <div class="card-body">
                                <div class="row">
                          <div class="col-sm-6 col-xl-2">
                                <div class="form-group">
                ...
                <?php } } ?>
                    ...
                    <div class="card">
                        ...
                        <div id="collapseSeven" class="collapse fade show" aria-labelledby="headingSeven" data-parent="#accordionExample">
                            <div class="card-body">
                                 <div class="row">
                         <div class="col-sm-6 col-xl-4">
                                <div class="form-group">
...
if($ext=='jpg' || $ext=='jpeg' || $ext=='png' || $ext=='bmp' || $ext=='gif')
{
    ...
    ?>
                     ...
                     <div class="card">
                        ...
                        <div id="collapseEight" class="collapse fade show" aria-labelledby="headingEight" data-parent="#accordionExample">
                            <div class="card-body">
                                <!-- PF --> 
...
<?php } ?>
                    ...
                    <div class="card">
                        <div class="card-header" id="headingNine">
                         ...
                         <div id="collapseNine" class="collapse fade show" aria-labelledby="headingNine" data-parent="#accordionExample">
                            <div class="card-body">
                                 <div class="row">
								  <div class="col-sm-6 col-xl-4">
                                <div class="form-group">
