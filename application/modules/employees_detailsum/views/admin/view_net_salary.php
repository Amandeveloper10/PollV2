<table class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Description</th>
                                                <th>Monthly [CTC: <?=number_format(round($ctcVal/12))?>]</th>
                                                <th>Yearly [CTC: <?=number_format(round($ctcVal))?>]</th>
                                                <!-- <th>Additions</th>
                                                <th>Deductions</th> -->
                                            </tr>
                                        </thead>
...
<?php 
                                            ...
                                            <tr>
                                                ...
                                                <td>PF (Employee Contribution <?=$employee_pf_percent.'%'?>)<?php if($choiceofpf == 'Y'){ ?><input type="checkbox" name="pf_show_checkbox" id="pfcheck" onclick="calculateSalary();" value="1" checked="checked" ><?php } else{ ?><input type="checkbox" name="pf_show_checkbox" id="pfcheck" disabled="" value="1" checked="checked" ><?php } ?>
                                        ...
                                        <?php } } ?>
                                         ...
                                         <?php 
                                            ...
                                            <tr>
                                                ...
                                                <td>ESI (Employee Contribution <?=$employee_esi_percent.'%'?>)<?php if($checkedesi == 'Y'){ ?><input type="checkbox" name="esi_show_checkbox" id="esicheck" onclick="calculateSalary();" value="1" checked="checked" ><?php } else{ ?><input type="checkbox" name="esi_show_checkbox" id="esicheck" disabled="" value="1" checked="checked" ><?php } ?>
...
<?php 
   ...
   if (!empty($data_single->not_part_ctc_component_id)) { 
    $nonctcArr = explode(',', rtrim($data_single->not_part_ctc_component_id, ","));?>
<div class="row mt-2">
    <div class="col-12">
                ...
                <div class="row">
                        <div class="col-xl-4">
                            <div class="form-group">
                               ...
                               <input class="form-control mysingle_date" id="application_date" name="application_date" value="<?=date('d-m-Y',strtotime(@$data_single->application_date))?>" type="text" placeholder="Select Date..">
                            </div>
                        </div>
                        <div class="col-xl-12">                            
                                <label for="" class="form-control-label">Note</label>
                                <textarea placeholder="Enter note" class="form-control inputDisabled" name='note'  id='note' rows="4"><?=@$data_single->note?></textarea>                            
                        </div> 
                        </div>