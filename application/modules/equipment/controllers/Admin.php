...
class Admin extends MX_Controller {
    ...
    public function __construct() {
        parent::__construct();
        admin_authenticate();
        $this->load->model('admin/EquipmentModel');
    }
    ...
    public function index($id=NULL) {
        $all_data = $this->EquipmentModel->load_all_data();
       ...
       // echo "<pre>"; print_r($all_data); //die;
        if($id){
            $this->load->view('equipment/admin/list',$this->data);
        }else{
            $this->middle = 'equipment/admin/list';
        $this->layout();
        }
    }
     ...
     */
     ...
     public function form($id = NULL) {        
        ...
        $flg = $this->EquipmentModel->modify($id);            
        }        
    }
    ...
    public function get_form() {
       ...
       // echo "<pre>"; print_r($_POST); die;
        ...
        if (!empty($id)) {
            $this->data['data_single'] = $this->EquipmentModel->load_single_data($id);
            $this->data['id'] = $id;  
        }  
        //echo "<pre>"; print_r($this->data['data_single']); //die;
        $view = $this->load->view('equipment/admin/form',$this->data, TRUE);
        echo $view; exit();         
    }
    ...
    public function status($id) {
        $this->EquipmentModel->status_change($id);
    }
    ...
    public function delete($id) {
        $this->EquipmentModel->delete_this($id);
    }
}
