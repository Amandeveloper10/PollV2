<div class="ks-page-header">
    <section class="ks-title">
		 ...
		 <h3><span>Settings > HR Master ></span> Equipments</h3>
        ...
        <div class="content-wrapper">            
            ...
            <table id="payrolltable" class="table table-list">
                ...
                <?php
                    ...
                    ?>
                  <tr>
                    <td><a class="" href="javascript:void(0)" onclick="openForm(<?php echo $data->id; ?>);"><?php echo $data->equipment_name; ?></a></td>
                    <td><?php echo $data->quantity; ?></td>
                     <td><?php if($data->assigned == '' || $data->assigned == '0'){ echo '';} else {echo $data->assigned;} ?></td>
...
function btnCloseForm(){
    ...
    function openForm(id){
         $.post("<?php echo base_url('admin_get_edit_form_equipment'); ?>", {id: id}, function(result){
            //console.log(result);
    ...
    function change_status(id) {
     ...
     function delete_this(id) {
        $("#myModal").on('shown.bs.modal', function() {
            $("#modal_confirm").click(function() {
               var url = "<?php echo base_url('admin_delete_equipment'); ?>/" + id;
                $("#pjax-container").load(url,function(response,status){                     
                    notification(status);
                });
            });
