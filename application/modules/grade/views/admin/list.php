<div class="ks-page-header">
    <section class="ks-title">
        <h3> <span>Settings > Employee Master > Grade</span></h3>
            ...
            <table id="payrolltable" class="table table-list">
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td class="text-right"><?php echo $data->min_salary; ?></td>
                    <td class="text-right"><?php echo $data->max_salary; ?></td>
...
// datatable end 
    ...
    function openForm(id){
         $.post("<?php echo base_url('admin_get_edit_form_grade'); ?>", {id: id}, function(result){
           // console.log(result);
    ...
    function change_status(id) {
        $("#myModal").on('shown.bs.modal', function() {
            $("#modal_confirm").click(function() {
                var url = "<?php echo base_url('admin_status_grade'); ?>/" + id;
            ...
            $("#notification_body").html("Do you want to change status of this grade?");
        }).modal("show");
    }
     ...
     function delete_this(id) {
        $("#myModal").on('shown.bs.modal', function() {
            $("#modal_confirm").click(function() {
               var url = "<?php echo base_url('admin_delete_grade'); ?>/" + id;
                $("#pjax-container").load(url,function(response,status){
                    notification(status);
                });
            });
            ...
            $("#notification_heading").html("Confirmation");
            $("#notification_body").html("Do you want to Delete this grade?");
        }).modal("show");
    }
</script>