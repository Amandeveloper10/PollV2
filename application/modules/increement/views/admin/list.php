    ...
    <section class="ks-title">
      <h3>Increement</h3>
        <div class="ks-controls">
            <a href="javascript:void(0)" class="btn btn-primary btn-add-vehicle" onclick="openForm('');">Add Increement</a>
        </div>
    </section>
</div>
...
<!--        <div class="ks-nav ks-browse">
        ...
        <div class="ks-nav-body" style="padding:20px;">
            ...
            <table id="ks-datatable" class="table table-list" >
                        <thead>
                        <tr>
                            <th>Employee Name </th>
                            <th>Component</th>
                            <th>Increement Date</th>
                            <th>Amount</th>
                            <th>Type</th>
                            <th>&nbsp;</th>
                        </tr>
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td><span ><?php echo $data->increement_date; ?></span></td>
...
<!-- The Modal -->
<div class="modal" id="validation_Model">
  <div class="modal-dialog">
    <div class="modal-content">

      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title" id="validation_heading"></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>

      <!-- Modal body -->
      <div class="modal-body" >
       <p id="validation_body"></p>
      </div>
...
<script type="text/javascript">
  function openForm(id){
       $.post("<?php echo base_url('admin_get_edit_form_increement'); ?>", {id: id}, function(result){
          //console.log(result);
  ...
  function delete_this(id) {
        $("#myModal").on('shown.bs.modal', function() {
            $("#modal_confirm").click(function() {
               var url = "<?php echo base_url('admin_delete_increement'); ?>/" + id;
