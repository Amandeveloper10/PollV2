<div class="ks-page-header">
    <section class="ks-title">
        <h3>Pay register for <?=date('F', mktime(0, 0, 0, $month, 10)).' - '.$year?></h3>
            ...
            <div class="content-wrapper">
                <div class="custom-tab payrolltab">
                    ...
                    <?php 
                      ...
                      ?>                    
                        <li class="nav-item"><a class="nav-link register" data-toggle="pill">Register <i class="la la-check <?php if(!empty($payroll_freez)){ echo 'bg-success';} ?>"></i></a></li>
                    </ul>
                </div>                
