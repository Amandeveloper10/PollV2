                ...
                <tr>
                    <td>
                        <table class="table table-emp-dtls">
                            ...
                            <?php 
                           // echo $employee_details->id; 
                            $emp_payroll = $this->PayrollModel->get_row_data('employee_payroll', array('employee_id' => @$employee_details->id,'delete_flag'=>'N','month'=>$month,'year'=>$year));
                            //echo '<pre>'; print_r($emp_payroll); die;
               ...
               <tr>
                  <td >
                      ...
                      <tr>
                        ...
                        <td>
                            <strong><?php if($emp_payroll->withday != ''){ echo $emp_payroll->withday;}?></strong>
                        </td>
                        <td>
                       ...
                       <tr>
                        ...
                        <td>
                            <strong><?php if($emp_payroll->withoutday != ''){ echo $emp_payroll->withoutday;}?></strong>
                        </td>
                        <td>
                                ...
                                <tr>
                                    <td>
                                        <table class="table table-earning">
                                            ...
                                            <?php $Earning = $this->PayrollModel->get_result_data('employee_payroll_details', array('employee_payroll_id' => $emp_payroll->id,'type'=>'Earning'));
                                            if(!empty($Earning)){
                                             ...
                                             $Component = $this->PayrollModel->get_row_data('master_salary_component', array('id' => $value->component_id));
                                              ?>
                                                  ...
                                                  <?php } } ?>
                                                   ...
                                                   <?php $pay = $this->PayrollModel->get_result_data('employee_payroll_details', array('employee_payroll_id' => $emp_payroll->id,'type'=>'Adhoc_pay'));
                                                    if(!empty($pay)){
                                        ...
                                        <table class="table table-deduction">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php $Deduction = $this->PayrollModel->get_result_data('employee_payroll_details', array('employee_payroll_id' => $emp_payroll->id,'type'=>'Adhoc_deduction'));
                                                    if(!empty($Deduction)){
                                                    ...
                                                    <?php } } ?>
                                                   <?php if($emp_payroll->pf == '1'){ ?>
                                                        <tr>
                                                        <td>PF</td>
                                                        <td><?php if($emp_payroll->pf == '1'){ echo number_format(round($emp_payroll->employeemothlypf));}?></td>
                                                    </tr>
												   <?php } ?>
												   <?php if($emp_payroll->esi == '1'){ ?>
                                                      <tr>
                                                        <td>ESI</td>
                                                        <td><?php if($emp_payroll->esi == '1'){ echo number_format(round($emp_payroll->employeemothlyesi));}?></td>
                                                    </tr>
												   <?php } ?>
                                                    <?php if($emp_payroll->ptax == '1'){ ?>
                                           <tr>
                                                        <td>PTax</td>
                                                        <td><?php if($emp_payroll->ptax == '1'){ echo number_format(round($emp_payroll->mothlyptax));}?></td>
                                                    </tr>
													<?php } ?>
                                            ...
                                            <td>
                                                <table class="table table-earning2">
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td></td>
                                                        <td  style="text-align: right;"><?php if(!empty($emp_payroll)){ echo number_format(round($emp_payroll->total_gross));}?></td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td>
                                                <table class="table table-deduction2">
                                                    <tr>
                                                        <td>Total Deductions</td>
                                                         <td></td>
														 <td></td>
                                                        <td style="text-align: right;"><?php if(!empty($emp_payroll)){ echo number_format(round($emp_payroll->total_deduction));}?></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                    ...
                    <td>
                        <table class="table table-netsalary">
                            <tr>
                                ...
                                <td>
                                    <strong><?php if(!empty($emp_payroll)){ echo number_format(round($emp_payroll->take_home));}?></strong>
                                </td>                      
                                <td rowspan="2">
