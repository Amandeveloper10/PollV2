...
<div class="ks-page-content">
    <div class="ks-page-content-body">
        ...
        <div class="content-wrapper">            
            ...
            <div class="table-responsive visible-x">
            <table id="payrolltable" class="table table-list" >
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td><?php echo $data->mandatory_grade; ?></td> 
                     <td class="table-action">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
                            <a class="dropdown-item" href="javascript:void(0)" onclick="openForm(<?php echo $data->id; ?>);"><span class="la la-pencil icon text-primary-on-hover"></span> Edit</a>
                            <?php
                                if ($data->is_active == "Y") {
                            ...
                            ?>
                            <a class="dropdown-item" href="javascript:void(0)" onclick="delete_this(<?php echo $data->id; ?>);"><span class="la la-trash icon text-danger-on-hover"></span> Delete</a>
                        </div>                                                
                    </td>                               
                  </tr>
                  <?php $sl++; } } ?>    
...
// datatable end 
    ...
    function openForm(id){
         $.post("<?php echo base_url('admin_get_edit_form_education'); ?>", {id: id}, function(result){
            //console.log(result);
    ...
    function change_status(id) {
        $("#myModal").on('shown.bs.modal', function() {
            $("#modal_confirm").click(function() {
                var url = "<?php echo base_url('admin_status_education'); ?>/" + id;
            ...
            $("#notification_body").html("Do you want to change status of this education?");
        }).modal("show");
    }
     ...
     function delete_this(id) {
        $("#myModal").on('shown.bs.modal', function() {
            $("#modal_confirm").click(function() {
               var url = "<?php echo base_url('admin_delete_education'); ?>/" + id;
                $("#pjax-container").load(url,function(response,status){                           
                    notification(status);
                });
            });
            ...
            $("#notification_heading").html("Confirmation");
            $("#notification_body").html("Do you want to Delete this education?");
        }).modal("show");
    }
</script>