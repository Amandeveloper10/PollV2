...
class Admin extends MX_Controller {
    ...
    $id=   $this->input->post('id');
     ...
     //echo $this->db->last_query();exit;
       ...
       // print_r($this->data['all_component_type']);
        echo $this->data['all_component_type']->type.', '.$this->data['all_component_type']->mode.', '.$this->data['all_component_type']->fixed.','.$this->data['all_component_type']->alias.','.$this->data['all_component_type']->pf.','.$this->data['all_component_type']->esi;exit;
    ...
    public function div_deduction_colon() {
      ...
      //  echo '<pre>';
       // echo '<pre>'; print_r($all_deductioncomponent); die;
      // exit;
         $div.= '<tr id="deduction_'.$id.'"><td><div class="form-group">
                 <select onchange="fordeductiontype(this.value)" id="component_deduction'.$id.'" name="component_deduction[]" class="form-control seldeduction">
        ...
        <td class="dedfixed_new'.$id.'" style="display:none;"></td>
        <td class="dedfixed_new'.$id.'" style="display:none;"></td>
         <td class="text-right"><strong class="monthly_deduction" id="calculate_deductionamountmonthly'.$id.'">0.00</strong></td>
        <td class="text-right"><strong class="total_deduction" id="calculate_deductionamount'.$id.'">0.00</strong></td>
		</tr>';
