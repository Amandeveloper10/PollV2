...
<!--<table>-->
    ...
    <tr>
        <td><div class="">
                <select onchange="fortype(this.value)" id="component" name="component[]" class="form-control" required>
                    <option value="">Select</option>
                    <?php
        ...
        <td> <input placeholder="%" style="width: 47px;" type="text" name="amount[]" onkeyup="numeric(this),salarycalculation(this.value);" id="amount" class="form-control text-right amount" required>
  ...
  <tbody>
     <tr>
     	<th><div class="col-xl-2 text-right">
            ...
            <label><a href="javascript:void(0)" class="text-primary" id="add_earning_head" onclick="get_div_experience();">Add</a></label>
        </div> </th>
...
<!--<table>-->
  ...
  <div class="row mt-2">
    ...
    <table class="table table-bordered mb-0">    
    <tbody>
      <?php if($SysOrganization->pf_apply == '1'){?>
    ...
    <?php } } ?>
     ...
     <?php 
      if($SysOrganization->esi_apply == '1'){
    ...
    <?php } } ?>
     ...
     <?php 
     if($SysOrganization->ptax_apply == '1'){
 ...
 <?php
  ...
  <tr>
		...
		<td class="text-right"><strong class="monthly_deduction" id="deduction_amount_monthly">0.00</strong></td>
        <td class="text-right"><strong class="total_deduction" id="deduction_amount">0.00</strong></td>
 ...
 <tbody class="deduction_sal_repeat"></tbody>
   <tbody>
	 ...
	 <th><div class="col-xl-2 text-right">
            <input type="hidden" name="deduction_div" id="deduction_div" value="<?php echo ((isset($data_single_exp) && (count($data_single_exp)) > 0) ? count($data_single_exp) : '1'); ?>">
            <input type="hidden" name="deduction_div_type" id="deduction_div_type" value="<?php echo ((isset($data_single_exp) && (count($data_single_exp)) > 0) ? count($data_single_exp) : '0'); ?>">
            <label><?php if (!empty($all_component_deduction)) { ?><a href="javascript:void(0)" class="text-primary" onclick="get_div_deduction();">Add</a></label> <?php } ?></th>
        <th colspan="5" style="text-align: right;">Total Deduction</th>
 ...
 <tbody class="benefit_sal_repeat"></tbody>
     ...
     <tr>
      <th><div class="col-xl-2 text-right">
            <input type="hidden" name="benefit_div" id="benefit_div" value="<?php echo ((isset($data_single_bef) && (count($data_single_bef)) > 0) ? count($data_single_bef) : '1'); ?>">
            <input type="hidden" name="benefit_div_type" id="benefit_div_type" value="<?php echo ((isset($data_single_bef) && (count($data_single_bef)) > 0) ? count($data_single_bef) : '0'); ?>">
            <label> <?php if (!empty($all_component_Annual)) { ?><a href="javascript:void(0)" class="text-primary" onclick="get_div_benefit();">Add</a><?php } ?></label>
        </div>
      </th>
