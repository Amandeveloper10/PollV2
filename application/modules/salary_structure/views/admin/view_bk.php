...
<!--                            <option value="Basic Salary" >Basic Salary</option>-->
        ...
        <td> <input placeholder="%" style="width: 47px;" type="text" name="amount[]" onkeyup="numeric(this),salarycalculation(this.value);" id="amount" class="form-control text-right amount"></td>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('input[name="pf"]').click(function(){
            if($(this).prop("checked") == true){
               ...
               var basicAmount = $('.basicAmount').text(); 
                ...
                if(parseFloat(basicAmount) >= parseFloat(letpfamount)){
                  ...
                  $("#pf_employee_deduction_monthly").text(employee_deduction/12);
                  
                  $("#pf_employee_deduction_benefit").text(employer_deduction);
                  $("#pf_employee_deduction_benefit_monthly").text(employer_deduction/12);
         ...
         $('input[name="esi"]').click(function(){
            ...
            $("#esi_employee_deduction_monthly").text(employee_deduction/12);
            $("#esi_employee_deduction_benefit").text(employer_deduction);
            $("#esi_employee_deduction_benefit_monthly").text(employee_deduction/12);
             var totaldeduction = 0;
                  $('.total_deduction').each(function() {
  ...
  $('input[name="adjustment"]').click(function(){
            ...
            $('#adjustment_amount').val(balancing_amount);
            $('#total_adjustment_amount').text(balancing_amount);
            $('#monthly_adjustment_amount').text(balancing_amount/12);
            ...
            $('.total_amount').each(function() {
                  ...
                  $("#total_gross_earning").text(totalearning);
