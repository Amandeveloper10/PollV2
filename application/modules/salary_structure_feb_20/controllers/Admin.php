    ...
    public function div_colon() {
      ...
      // exit;
        ...
        <td class="fixed_new'.$id.'" style="display:none;"></td>
         ...
         <td><span class="total_amount_monthly" id="monthly_calculate_amount'.$id.'">0.00</span></td>
        <td class="tr-delete"><span class="total_amount" id="calculate_amount'.$id.'">0.00</span> <button type="button" name="delete" id="delete" style="display:none" class="btn btn-danger delete"><span onclick="deleteDiv(\'exp\','.$id.');" title="Delete" class="ks-icon la la-trash" aria-hidden="false" ></span></button> </td></tr>';
