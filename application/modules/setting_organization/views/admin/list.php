    ...
    <div class="ks-page-content-body">
        <div class="container-fluid">
            <div class="content-wrapper">
                ...
                <form onsubmit="return myFunction('setting_organization')" method="post" action="<?php echo base_url('admin_add_setting_organization'); ?>" name="setting_organization" id="setting_organization" enctype="multipart/form-data" >
                  <div class="row">                      
                  <div class="flex-fixed-width-100">
                        <div class="form-group">
                            ...
                            <span class="btn btn-info btn-file btn-square-round">
                                ...
                                <input type="file" name="image" id="image" onchange="readURL(this,'setting_organization')" >
                            </span>                            
<!--                            <input onchange="readURL(this,'setting_organization')" type="file" name="image" id="image"
                    ...
                    <div class="col-12 col-sm">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" id="company_name" maxlength ="20" name="company_name" value="<?php echo (isset($data_single->company_name) ? $data_single->company_name : ''); ?>">
                                </div>        
                            </div>
                      ...
                      <div class="col-lg-4">
                          <div class="form-group">                              
                              <input placeholder="Incorporation date" type="text" class="form-control mysingle_date" id="incorporation_date"  name="incorporation_date" value="<?php echo (isset($data_single->incorporation_date) ? date($SysConfigauthenticaton->date_format,strtotime($data_single->incorporation_date)) : date($SysConfigauthenticaton->date_format)); ?>">
                          </div>        
                      </div>
                      ...
                      <div class="col-lg-4">
						...
						<input type="checkbox" class="custom-control-input" name="pf_apply" id="pf_apply" <?php echo ((isset($data_single->pf_apply) && ($data_single->pf_apply=='1')) ? 'checked' : ''); ?> value="<?php echo (isset($data_single->pf_apply) ? $data_single->pf_apply : '0'); ?>"><label class="custom-control-label" for="pf_apply"> Provident Fund Account</label>						
						</div>                            
                      ...
                      <div class="col-lg-4">
                          <div class="form-group">                              
                              <input placeholder="Registration Date" type="text" class="form-control mysingle_date" id="pf_reg_date"  name="pf_reg_date" value="<?php echo (isset($data_single->pf_reg_date) ? date($SysConfigauthenticaton->date_format,strtotime($data_single->pf_reg_date)) : date($SysConfigauthenticaton->date_format)); ?>">
                          </div>        
                      </div>
                      ...
                      <div class="col-lg-4">
						...
						<div class="custom-control custom-checkbox ml-0">
						<input type="checkbox" class="custom-control-input" name="esi_apply" id="esi_apply" <?php echo ((isset($data_single->esi_apply) && ($data_single->esi_apply=='1')) ? 'checked' : ''); ?> value="<?php echo (isset($data_single->esi_apply) ? $data_single->esi_apply : '0'); ?>"><label class="custom-control-label" for="esi_apply"> ESI</label>
						</div>  
                      ...
                      <div class="col-lg-4">
                          <div class="form-group">                              
                              <input placeholder="Registration Date" type="text" class="form-control mysingle_date" id="esi_reg_date"  name="esi_reg_date" value="<?php echo (isset($data_single->esi_reg_date) ? date($SysConfigauthenticaton->date_format,strtotime($data_single->esi_reg_date)) : date($SysConfigauthenticaton->date_format)); ?>">
                          </div>        
                      </div>                      
                      ...
                      <div class="col-lg-4">
						...
						<div class="custom-control custom-checkbox ml-0">
						<input type="checkbox" class="custom-control-input" name="ptax_apply" <?php echo ((isset($data_single->ptax_apply) && ($data_single->ptax_apply=='1')) ? 'checked' : ''); ?> id="ptax_apply" value="<?php echo (isset($data_single->ptax_apply) ? $data_single->ptax_apply : '0'); ?>"><label class="custom-control-label" for="ptax_apply"> Professional Tax Account</label>
						</div>  
                      ...
                      <div class="col-lg-4">
                          <div class="form-group">                              
                              <input placeholder="Registration Date" type="text" class="form-control mysingle_date" id="p_tax_reg_date"  name="p_tax_reg_date" value="<?php echo (isset($data_single->p_tax_reg_date) ? date($SysConfigauthenticaton->date_format,strtotime($data_single->p_tax_reg_date)) : date($SysConfigauthenticaton->date_format)); ?>">
                          </div>        
                      </div>
                      ...
                      <div class="col-lg-4">
                       ...
                       <div class="col-md-12">
						...
						<div class="custom-control custom-checkbox ml-0">
                            <input type="checkbox" class="custom-control-input" name="gratuity_apply" id="gratuity_apply" <?php echo ((isset($data_single->gratuity_apply) && ($data_single->gratuity_apply=='1')) ? 'checked' : ''); ?> value="<?php echo (isset($data_single->gratuity_apply) ? $data_single->gratuity_apply : '0'); ?>"><label class="custom-control-label" for="gratuity_apply"> Gratuity</label>
						</div>  
						</div>						
