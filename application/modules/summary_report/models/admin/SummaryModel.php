...
//            }
        ...
        $query_leave = $this->db->get();
        $result_leave = $query_leave->result();
        //echo '<pre>';print_r($result_leave); die;
       // if (!empty($result_leave)) {
        foreach ($result_leave as $value) {
            $stop_date = date('Y-m-d H:i:s', strtotime($value->leave_to . ' +1 day'));
            $period = new DatePeriod(
  ...
  public function get_all_nos_taken($monthname=NULL,$leave_id=NULL,$employee_id=NULL) {
    ...
    public function get_all_nos_opening($leave_id=NULL,$employee_id=NULL,$current_month=NULL) {
...
//die;
    ...
    public function get_all_nos_lop($employee_id=NULL,$month=NULL) {
