...
<form onsubmit="return myFunction('timeoff_form')" method="post" action="<?php echo (isset($id) && $id != '') ? base_url('admin_edit_timeoff').'/'.$id : base_url('admin_add_timeoff'); ?>" name="timeoff_form" id="timeoff_form" enctype="multipart/form-data" >
<div class="row">
      ...
      <div class="col-sm-6 col-xl-4 officialDiv"  <?php if(isset($data_single->type) && @$data_single->type=='Official'){ ?>  <?php }else{ ?> style="display: none;" <?php } ?>>
        <div class="form-group">
            ...
            <select class="form-control" id="work_status" name="work_status" onchange="get_all_employee(),getallvalue(this.value);">
