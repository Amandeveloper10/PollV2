        ...
        <div class="container-fluid">        
            <div class="content-wrapper">                
                <div class="card-nav d-flex">
                    <ul class="nav">
                        <li class="nav-item"><a class="nav-link pjaxCls active" href="<?php echo base_url('page/48'); ?>">Listing</a></li>
                        <li class="nav-item"><a class="nav-link pjaxCls" href="<?php echo base_url('page/58'); ?>">Maintenance Record</a></li>
                        <li class="nav-item"><a class="nav-link pjaxCls" href="<?php echo base_url('vehicle_asignment_form'); ?>">Assign Vehicle to Employee</a></li>
                        <li class="nav-item"><a class="nav-link pjaxCls" href="<?php echo base_url('page/59'); ?>">Assignment History</a></li>
                    </ul>
                </div>
            ...
            <table id="payrolltable" class="table table-list">
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $data->vehicle_reg_code; ?></td>
                                <td><?php echo $data->vehicle_name; ?></td>
                                <td><?php echo $data->vehicle_model_year; ?></td>
                                <td><?php echo $data->purchase_amount; ?></td>
                                <td><?php echo $data->assign_emloyee; ?></td>
                                <td><?php if($data->reg_doc!=''){ ?><a target="_blank" href="<?php echo base_url() ?>uploads/<?php echo $data->reg_doc; ?>">View</a><?php } ?></td>
                                <td><?php if($data->insur_doc!=''){ ?><a target="_blank" href="<?php echo base_url() ?>uploads/<?php echo $data->insur_doc; ?>">View</a><?php } ?></td>
  ...
  function delete_this(id) {
        $("#myModal").on('shown.bs.modal', function() {
            $("#modal_confirm").click(function() {
               var url = "<?php echo base_url('admin_delete_vehicles'); ?>/" + id;
            ...
            $("#notification_body").html("Do you want to Delete this Vehicles?");
        }).modal("show");
    }
