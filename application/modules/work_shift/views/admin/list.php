<div class="ks-page-header">
    <section class="ks-title">
        <h3><span>Settings > Employee Master > </span> Work Shift</h3>
    ...
    <div class="ks-page-content-body">
        ...
        <div class="content-wrapper">            
            ...
            <table id="payrolltable" class="table table-list">
                <thead>
                    <tr>
                        <th colspan="2" class="text-center" style="background-color: #eee;border-right: 1px solid #999;"></th>
                        <th colspan="3" class="text-center" style="background-color: #eee;border-right: 1px solid #999;">Full Working Days</th>
                        <th colspan="3" class="text-center" style="background-color: #eee;border-right: 1px solid #999;">Half Working Days</th>
                        <th colspan="" style="background-color: #eee;"></th>
                    </tr>
                  <tr>
                    <th>Shift Name</th>
                    <th>Grace</th>
                ...
                <?php
                    ...
                    if (!empty($all_data)) {
                      foreach ($all_data as $data) {
                         $offday = $this->WorkShiftModel->get_result_data('master_work_shift_off_day',array('work_shift_id'=>$data->id));
                    ?>
                  <tr>
                    <td><a class="pjaxCls" href="javascript:void(0)" onclick="openForm(<?php echo $data->id; ?>);"><?php echo $data->work_shift_name; ?></a></td>
                    <td><?php echo $data->work_hour_grace; ?></td>

                    <td><?php echo $data->work_hour_start_1; ?></td>
                    <td><?php echo $data->work_hour_end_1; ?></td>
                    <td><?php echo $data->work_hour_duration_1; ?></td>

                    <td><?php echo $data->work_hour_start_2; ?></td>
                    <td><?php echo $data->work_hour_end_2; ?></td>
                    <td><?php echo $data->work_hour_duration_2; ?></td>
...
// datatable end 
    ...
    function openForm(id){
         $.post("<?php echo base_url('admin_get_edit_form_work_shift'); ?>", {id: id}, function(result){
            //console.log(result);
    ...
    function change_status(id) {
        $("#myModal").on('shown.bs.modal', function() {
            $("#modal_confirm").click(function() {
                var url = "<?php echo base_url('admin_status_work_shift'); ?>/" + id;
            ...
            $("#notification_body").html("Do you want to change status of this Work Shift?");
        }).modal("show");
    }
     ...
     function delete_this(id) {
        $("#myModal").on('shown.bs.modal', function() {
            $("#modal_confirm").click(function() {
               var url = "<?php echo base_url('admin_delete_work_shift'); ?>/" + id;
                $("#pjax-container").load(url,function(response,status){                    
                    notification(status);
                });
            });
            ...
            $("#notification_heading").html("Confirmation");
            $("#notification_body").html("Do you want to Delete this Work Shift?");
        }).modal("show");
    }
