                                ...
                                <div class="tab-pane fade p-0 show active" id="pills-general" role="tabpanel" aria-labelledby="pills-general-tab">
                                    <div class="card panel">
                                        ...
                                        <div class="card-block">
                                            ...
                                            <h6 class="mt-2 mb-3">Basic Details</h6>
                                            <hr>
                                            <div class="row">
                                            ...
                                            <h6 class="mt-3 mb-3">Personal Details</h6>
                                            <hr>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                            ...
                                            <h6 class="mt-3 mb-3">Contact Details</h6>
                                            <hr>
                                            <div class="row">
                                                <div class="col-sm-6 col-xl-4">
                                                    <div class="form-group">
                                            ...
                                            <h6 class="mt-3 mb-3">Home Contact Details</h6>
                                            <hr>
                                            <div class="row">
                                                <div class="col-sm-6 col-xl-4">
                                                    <div class="form-group">
