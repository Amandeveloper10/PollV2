                    ...
                    <div class="ks-nav-body">
                        <div class="ks-user-list-view-header-block">
                            <h4 class="ks-user-list-view-header-block-name">
                                <span class="d-none d-sm-block">All Employee</span>
                            ...
                            <div class="ks-user-list-view-header-control">
                                <a href="<?php echo base_url('page/56'); ?>" class="btn btn-success">Add Employee</a>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-action">
                                                <div class="dropdown">
                                                    ...
                                                    <a class="dropdown-item " href="<?php echo base_url('page/57'); ?>"><span class="la la-eye icon text-primary-on-hover"></span> View
                                                        </a>
                                                        <a class="dropdown-item " href="<?php echo base_url('page/57'); ?>">
                                                            <span class="la la-pencil icon text-primary-on-hover"></span> Edit
                                                        </a>
                                                        <a class="dropdown-item " href="<?php echo base_url('page/57'); ?>"><span class="la la-trash icon text-danger-on-hover"></span> Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
