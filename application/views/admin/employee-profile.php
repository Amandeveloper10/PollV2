...
<div class="profile-img">
    <img src="<?php echo base_url(); ?>assets/img/avatars/avatar-2.jpg" class="ks-avatar" width="100" height="100">
...
<div class="ks-info mt-0">
    <div class="ks-name">Amy Gonzales</div>
    <div class="ks-description">Product Manager</div>
    <div class="ks-description">Employee No. <b>0A-124</b></div>
    <div class="ks-manage-avatar-body-controls mt-4">
        <button type="button" class="btn btn-primary">
            <span class="la la-upload ks-icon"></span>
            <span class="ks-text">Change Avatar</span>
        </button>
    </div>
</div>
</div>
...
<div class="ks-menu">
    <ul class="nav nav-pills nav-stacked">
        ...
        <li class="nav-item">
            <a class="nav-link" id="pills-salary-tab2" data-toggle="pill" href="#pills-salary2" role="tab" aria-controls="pills-salary2" aria-selected="false">Salary2</a>
        </li>
        <li class="nav-item">
        ...
        <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xl-4">
                            <div class="card text-white bg-success panel panel-default ks-solid ks-widget ks-widget-tags mb-4">
                                ...
                                <div class="card-block">
                                    <span class="badge badge-pill badge-default-outline">UI/UX</span>
                                    <span class="badge badge-pill badge-default-outline">Web Design</span>
                                    <span class="badge badge-pill badge-default-outline">HTML</span>
                                    <span class="badge badge-pill badge-default-outline">CSS</span>
                                    <span class="badge badge-pill badge-default-outline">JS</span>
                                    <span class="badge badge-pill badge-default-outline">Photoshop</span>
                                    <span class="badge badge-pill badge-default-outline">Sketch</span>
                                    <span class="badge badge-pill badge-default-outline">PHP</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4">
                                ...
                                <div class="card-block">
                                    <table class="ks-table-description">
                                        ...
                                        <tr>
                                            ...
                                            <td class="ks-text">
                                                <a href="#">amy.gonzales@example.com</a>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter employee number" class="form-control inputDisabled" value="0A-124" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                            <div class="form-group">
                                <label for="" class="form-control-label">File No.</label>
                                <input type="text" placeholder="Enter file number" class="form-control inputDisabled" value="00-123" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                            <div class="form-group">
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter title" class="form-control inputDisabled" value="Title" disabled="disabled">
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter first name" class="form-control inputDisabled" value="Amy" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col pr-0">
                                        <input type="text" placeholder="Name 1" class="form-control inputDisabled" value="C" disabled="disabled">
                                    </div>
                                    <div class="col">
                                        <input type="text" placeholder="Name 2" class="form-control inputDisabled" value="Gonzales" disabled="disabled">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mt-2">
                        <div class="col-sm-6 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter department" class="form-control inputDisabled" value="Product" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                            <div class="form-group">
                                <label for="" class="form-control-label">Designation</label>
                                <input type="text" placeholder="Enter designation" class="form-control inputDisabled" value="Manager" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                            <div class="form-group">
                                <label for="" class="form-control-label">Hire Date</label>
                                <input type="text" placeholder="Select date" class="form-control ks-daterange-single inputDisabled" value="12/22/2016" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                            <div class="form-group">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter amount" class="form-control inputDisabled" value="3L" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                            <div class="form-group">
                                <label for="" class="form-control-label">PRO Name</label>
                                <input type="text" placeholder="Enter PRO Name" class="form-control inputDisabled" value="Name" disabled="disabled">
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-sm-6 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter leave per month" class="form-control inputDisabled" value="2" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                            <div class="form-group">
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea placeholder="Enter note" class="form-control inputDisabled" style="min-height: 120px; line-height: 20px;" disabled="disabled">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter father's name" class="form-control inputDisabled" value="Peter Gonzales" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="" class="form-control-label">Mother's Name</label>
                                <input type="text" placeholder="Enter mother's name" class="form-control inputDisabled" value="Ema Gonzales" disabled="disabled">
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-inline-block mt-2">
                                    <div class="custom-control custom-radio ks-radio ks-primary">
                                        <input id="r1" type="radio" class="custom-control-input inputDisabled" name="maritalStatus" checked="checked" disabled="disabled" 
                                ...
                                <div class="d-inline-block mt-2 ml-3">
                                    <div class="custom-control custom-radio ks-radio ks-primary">
                                        <input id="r2" type="radio" class="custom-control-input inputDisabled" name="maritalStatus" disabled="disabled" 
                                               data-validation="radio_group"
                                               data-validation-qty="min1">
                        ...
                        <div class="col-sm-6 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter spouce name" class="form-control inputDisabled" value="John C" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4">
                            <div class="form-group">
                                <label for="" class="form-control-label">No. of Children</label>
                                <input type="text" placeholder="Enter number of children" class="form-control inputDisabled" value="1" disabled="disabled">
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-sm-6 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter date" class="form-control inputDisabled" value="06/08/1984" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4">
                            <div class="form-group">
                                ...
                                <div class="d-inline-block mt-2">
                                    <div class="custom-control custom-radio ks-radio ks-info">
                                        <input id="r3" type="radio" class="custom-control-input inputDisabled" name="gender" disabled="disabled" 
                                               data-validation="radio_group"
                                               data-validation-qty="min1">
                                ...
                                <div class="d-inline-block mt-2 ml-3">
                                    <div class="custom-control custom-radio ks-radio ks-purple">
                                        <input id="r4" type="radio" class="custom-control-input inputDisabled" name="gender" checked="checked" disabled="disabled" 
                                               data-validation="radio_group"
                                               data-validation-qty="min1">
                        ...
                        <div class="col-sm-6 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter relegion" class="form-control inputDisabled" value="Christian" disabled="disabled">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter address" class="form-control inputDisabled" value="006 Deangelo Plaza Suite" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4">
                            <div class="form-group">
                                <label for="" class="form-control-label">City</label>
                                <input type="text" placeholder="Enter city" class="form-control inputDisabled" value="Marocco" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4">
                            <div class="form-group">
                    ...
                    <div class="row mt-2">
                        <div class="col-sm-6 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter telephone number" class="form-control inputDisabled" value=" 1 (555) 555-555-55" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4">
                            <div class="form-group">
                                <label for="" class="form-control-label">Mobile No.</label>
                                <input type="text" placeholder="Enter mobile number" class="form-control inputDisabled" value=" 1 (555) 555-555-55" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4">
                            <div class="form-group">
                                <label for="" class="form-control-label">Email</label>
                                <input type="text" placeholder="Enter email" class="form-control inputDisabled" value="amy.gonzales@example.com" disabled="disabled">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Enter university name" class="form-control inputDisabled" value="Dubai University" disabled="disabled">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="select" class="form-control inputDisabled" disabled="disabled">
                                        ...
                                        <option value="3" selected="selected">Diploma</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Enter nuber of Years Experience" class="form-control inputDisabled" value="2" disabled="disabled">
                                </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                                <div class="form-group">
                                    <label for="" class="form-control-label">No. of Projects Executed</label>
                                    <input type="text" placeholder="Enter number of Projects Executed" class="form-control inputDisabled" value="3" disabled="disabled">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-inline-block mt-2">
                                        <div class="custom-control custom-radio ks-radio ks-success">
                                            <input id="r5" type="radio" class="custom-control-input inputDisabled" name="society" checked="checked" disabled="disabled" 
                                                   data-validation="radio_group"
                                                   data-validation-qty="min1">
                                    ...
                                    <div class="d-inline-block mt-2 ml-3">
                                        <div class="custom-control custom-radio ks-radio ks-danger">
                                            <input id="r6" type="radio" class="custom-control-input inputDisabled" name="society" disabled="disabled" 
                                                   data-validation="radio_group"
                                                   data-validation-qty="min1">
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-6 col-xl-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Select date" class="form-control ks-daterange-single inputDisabled" value="12/22/2020" disabled="disabled">
                                </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control forCustomFile inputDisabled" placeholder="Upload file" value="Society Id Front Image" disabled="disabled">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary" type="button" data-toggle="modal" data-target="#idFront1" title="View"><span class="la la-eye ks-icon ml-2"></span></button>
                                        </div>
                                        <!-- Society Id Front Modal -->
                                        <div class="modal fade" id="idFront1" tabindex="-1" role="dialog"aria-hidden="true">
                            ...
                            <div class="col-sm-6 col-xl-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Select date" class="form-control ks-daterange-single inputDisabled" value="12/22/2017" disabled="disabled">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="d-inline-block mt-2">
                                        <div class="custom-control custom-radio ks-radio ks-success">
                                            <input id="r7" type="radio" class="custom-control-input inputDisabled" name="municipality" checked="checked" disabled="disabled" 
                                                   data-validation="radio_group"
                                                   data-validation-qty="min1">
                                    ...
                                    <div class="d-inline-block mt-2 ml-3">
                                        <div class="custom-control custom-radio ks-radio ks-danger">
                                            <input id="r8" type="radio" class="custom-control-input inputDisabled" name="municipality" disabled="disabled" 
                                                   data-validation="radio_group"
                                                   data-validation-qty="min1">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary" type="button" data-toggle="modal" data-target="#idBack2" title="View"><span class="la la-eye ks-icon ml-2"></span></button>
                                        </div>
                                        <!-- Municipality Id Back Modal -->
                                        <div class="modal fade" id="idBack2" tabindex="-1" role="dialog"aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="d-inline-block mt-2">
                                        <div class="custom-control custom-radio ks-radio ks-success">
                                            <input id="r9" type="radio" class="custom-control-input inputDisabled" name="trakhees" checked="checked" disabled="disabled" 
                                                   data-validation="radio_group"
                                                   data-validation-qty="min1">
                                    ...
                                    <div class="d-inline-block mt-2 ml-3">
                                        <div class="custom-control custom-radio ks-radio ks-danger">
                                            <input id="r10" type="radio" class="custom-control-input inputDisabled" name="trakhees" disabled="disabled" 
                                                   data-validation="radio_group"
                                                   data-validation-qty="min1">
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="No. of Cards" class="form-control inputDisabled" value="2" disabled="disabled">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Card Color" class="form-control inputDisabled" value="Green" disabled="disabled">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary" type="button" data-toggle="modal" data-target="#idFront3" title="View"><span class="la la-eye ks-icon ml-2"></span></button>
                                        </div>
                                        <!-- 1st Card Front Modal -->
                                        <div class="modal fade" id="idFront3" tabindex="-1" role="dialog"aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary" type="button" data-toggle="modal" data-target="#idBack3" title="View"><span class="la la-eye ks-icon ml-2"></span></button>
                                        </div>
                                        <!-- 1st Card Back Modal -->
                                        <div class="modal fade" id="idBack3" tabindex="-1" role="dialog"aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Card Color" class="form-control inputDisabled" value="Orange" disabled="disabled">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-6 col-xl-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control forCustomFile inputDisabled" placeholder="Upload file" value="2nd Card Front Image" disabled="disabled">
                                        <div class="custom-file replaceCustomFile" style="display: none;">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary" type="button" data-toggle="modal" data-target="#idFront4" title="View"><span class="la la-eye ks-icon ml-2"></span></button>
                                        </div>
                                        <!-- 2nd Card Front Modal -->
                                        <div class="modal fade" id="idFront4" tabindex="-1" role="dialog"aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary" type="button" data-toggle="modal" data-target="#idBack4" title="View"><span class="la la-eye ks-icon ml-2"></span></button>
                                        </div>
                                        <!-- 2nd Card Back Modal -->
                                        <div class="modal fade" id="idBack4" tabindex="-1" role="dialog"aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control forCustomFile inputDisabled" placeholder="Upload CV" value="Amy Gonzales CV" disabled="disabled">
                                        <div class="custom-file replaceCustomFile" style="display: none;">
            ...
            <div class="tab-pane fade p-0" id="pills-salary2" role="tabpanel" aria-labelledby="pills-salary-tab2">
            	<div class="form-box">
                	...
                	<div class="row">
                		<div class="col-sm-6">
                            <div class="form-group">
                                <label for="" class="form-control-label">Employee Code</label>
                                <input type="text" placeholder="Enter employee code" class="form-control inputDisabled" value="0A-124" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="" class="form-control-label">Joining Date</label>
                                <input type="text" placeholder="Select date" class="form-control ks-daterange-single inputDisabled" value="12/22/2015" disabled="disabled">
                            </div>
                        </div>
                	</div>
                	<div class="row mt-2">
                		<div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter name" class="form-control inputDisabled" value="Amy Gonzales" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="" class="form-control-label">Designation</label>
                                <input type="text" placeholder="Enter designation" class="form-control inputDisabled" value="Product Manager" disabled="disabled">
                            </div>
                        </div>
                	</div>
                	<div class="row mt-2">
                		<div class="col-sm-6">
                            <div class="form-group">
                                <label for="" class="form-control-label">Working At</label>
                                <input type="text" placeholder="Enter working at" class="form-control inputDisabled" value="Working" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="" class="form-control-label">Visa From</label>
                                <input type="text" placeholder="Enter visa from" class="form-control inputDisabled" value="Visa" disabled="disabled">
                            </div>
                        </div>
                	</div>
                	<div class="row mt-2">
                		<div class="col-sm-6">
                            <div class="form-group">
                                <label for="" class="form-control-label">Basic Salary</label>
                                <input type="text" placeholder="Enter basic salary" class="form-control inputDisabled" value="5,000.00" disabled="disabled">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="" class="form-control-label">Mobile #</label>
                                <input type="text" placeholder="Enter mobile" class="form-control inputDisabled" value="9123456780" disabled="disabled">
                            </div>
                        </div>
                	</div>
                	<div class="row mt-2">
                                ...
                                <div class="card-block" data-widget-content>
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th>OT Hours</th>
                                                <td><input type="text" placeholder="Enter OT Hours" class="form-control inputDisabled" value="0" disabled="disabled"></td>
                                                <td><input type="text" placeholder="Enter OT Hours" class="form-control inputDisabled" value="0" disabled="disabled"></td>
                                                <td><input type="text" placeholder="Enter OT Hours" class="form-control inputDisabled" value="0" disabled="disabled"></td>
                                            </tr>
                                            <tr>
                                                <th>OT Rate</th>
                                                <td><input type="text" placeholder="Enter OT Rate" class="form-control inputDisabled" value="54.58" disabled="disabled"></td>
                                                <td><input type="text" placeholder="Enter OT Rate" class="form-control inputDisabled" value="68.23" disabled="disabled"></td>
                                                <td><input type="text" placeholder="Enter OT Rate" class="form-control inputDisabled" value="81.88" disabled="disabled"></td>
                                            </tr>
                                            <tr>
                                                <th>Total Absent</th>
                                                <td>
                                                	<label for="" class="form-control-label">Full Day</label>
                                                	<input type="text" placeholder="Enter total full day absent" class="form-control inputDisabled" value="8" disabled="disabled">
                                                </td>
                                                <td>
                                                	<label for="" class="form-control-label">Half Day</label>
                                                	<input type="text" placeholder="Enter total half day absent" class="form-control inputDisabled" value="2" disabled="disabled">
                                                </td>
                                                <td></td>
                                            </tr>
                                        </tbody>
                                ...
                                <div class="card-block" data-widget-content>
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Basic Salary</td>
                                                <td><input type="text" placeholder="Enter basic salary amount" class="form-control inputDisabled" value="5,000.00" disabled="disabled"></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td>Allowance</td>
                                                <td><input type="text" placeholder="Enter allowance amount" class="form-control inputDisabled" value="2,700.00" disabled="disabled"></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td>Misc Allowance</td>
                                                <td><input type="text" placeholder="Enter misc allowance amount" class="form-control inputDisabled" value="500.00" disabled="disabled"></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td>Over Time</td>
                                                <td><input type="text" placeholder="Enter over time amount" class="form-control inputDisabled" value="0.00" disabled="disabled"></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td>Deductions</td>
                                                <td></td>
                                                <td><input type="text" placeholder="Enter over time amount" class="form-control inputDisabled" value="170.00" disabled="disabled"></td>
                                            </tr>
                                            <tr>
                                                <td>Loan</td>
                                                <td></td>
                                                <td><input type="text" placeholder="Enter over time amount" class="form-control inputDisabled" value="500.00" disabled="disabled"></td>
                                            </tr>
                                            <tr>
                                                <td>Absent</td>
                                                <td></td>
                                                <td><input type="text" placeholder="Enter over time amount" class="form-control inputDisabled" value="256.67" disabled="disabled"></td>
                                            </tr>
                                            <tr>
                                                <th>Net Salary</th>
                                                <th><input type="text" placeholder="Enter net salary amount" class="form-control inputDisabled" value="7,273.33" disabled="disabled"></th>
                                                <td></td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Enter passport number" class="form-control inputDisabled" value="AB-0123456" disabled="disabled">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="" class="form-control-label">Place of Issue</label>
                                    <input type="text" placeholder="Enter place of issue" class="form-control inputDisabled" value="Place" disabled="disabled">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="form-group">
                                    <label for="" class="form-control-label">Expiry Date</label>
                                    <input type="text" placeholder="Select date" class="form-control ks-daterange-single inputDisabled" value="12/22/2021" disabled="disabled">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="d-inline-block mt-2">
                                        <div class="custom-control custom-radio ks-radio ks-success">
                                            <input id="r21" type="radio" class="custom-control-input inputDisabled" name="retainedWithCompany" checked="checked" disabled="disabled" 
                                                   data-validation="radio_group"
                                                   data-validation-qty="min1">
                                    ...
                                    <div class="d-inline-block mt-2 ml-3">
                                        <div class="custom-control custom-radio ks-radio ks-danger">
                                            <input id="r22" type="radio" class="custom-control-input inputDisabled" name="retainedWithCompany" disabled="disabled" 
                                                   data-validation="radio_group"
                                                   data-validation-qty="min1">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control forCustomFile inputDisabled" placeholder="Upload file" value="Passport Images" disabled="disabled">
                                        <div class="custom-file replaceCustomFile" style="display: none;">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter employment offer cost" class="form-control inputDisabled" value="$80" disabled="disabled">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter application cost" class="form-control inputDisabled" value="$140" disabled="disabled">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-sm-6 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter policy no." class="form-control inputDisabled" value="AB-0123456" disabled="disabled">
                                    </div>   
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                    <div class="form-group">
                                        <label for="" class="form-control-label">Name of Finance Instituton</label>
                                        <input type="text" placeholder="Enter name of finance instituton" class="form-control inputDisabled" value="Finance Instituton" disabled="disabled">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                    <div class="form-group">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter application cost" class="form-control inputDisabled" value="$120" disabled="disabled">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-sm-6 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter Labor Card No." class="form-control inputDisabled" value="AB-0123456" disabled="disabled">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                    <div class="form-group">
                                        <label for="" class="form-control-label">Personal Id No.</label>
                                        <input type="text" placeholder="Enter Personal Id No" class="form-control inputDisabled" value="AB-0123456" disabled="disabled">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                    <div class="form-group">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter labor card cost" class="form-control inputDisabled" value="$120" disabled="disabled">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="" class="form-control-label">Expiry Date</label>
                                        <input type="text" placeholder="Select date" class="form-control ks-daterange-single inputDisabled" value="122/22/2021" disabled="disabled">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter visa card cost" class="form-control inputDisabled" value="$120" disabled="disabled">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Select date" class="form-control ks-daterange-single inputDisabled" value="22/12/2014" disabled="disabled">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter application ID No." class="form-control inputDisabled" value="AB-0123456" disabled="disabled">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-2">
                        ...
                        <div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="form-group">
                                        <label for="" class="form-control-label">Visa Cost</label>
                                        <input type="text" placeholder="Enter Visa cost" class="form-control inputDisabled" value="$120" disabled="disabled">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                    <div class="form-group">
                                        <label for="" class="form-control-label">UID No.</label>
                                        <input type="text" placeholder="Enter UID No." class="form-control inputDisabled" value="AB-0123456" disabled="disabled">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-2">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter policy name" class="form-control inputDisabled" value="Insurance Policy" disabled="disabled">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="" class="form-control-label">Expiry Date</label>
                                        <input type="text" placeholder="Select date" class="form-control ks-daterange-single inputDisabled" value="22/12/2021" disabled="disabled">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-2">
            ...
            <div class="tab-pane fade p-0" id="pills-loans" role="tabpanel" aria-labelledby="pills-loans-tab">
                <div class="card panel">
                    ...
                    <div class="card-block">
                        <a href="javascript:void(0);" type="btn" class="btn btn-outline-primary mt-4 btn-add-loan disabled btnDisabled">Add Loan</a>
