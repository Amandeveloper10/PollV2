                                        ...
                                        <div class="card panel panel-default ks-project">
                                            ...
                                            <div class="ks-project-body">
                                                <a href="#" class="ks-name">
                                                    ...
                                                    <span class="ks-text">Project Name</span>
                                                </a>
                                                    ...
                                                    <div class="ks-item ks-images">
                                                        ...
                                                        <div class="ks-description">
                                                            <a href="#" class="ks-image">
                                                                <img class="ks-avatar" src="assets/img/avatars/avatar-1.jpg" width="25" height="25">
                                                            </a>
                                                            <a href="#" class="ks-image">
                                                                <img class="ks-avatar" src="assets/img/avatars/avatar-5.jpg" width="25" height="25">
                                                            </a>
                                                            <a href="#" class="ks-image">
                                                                <img class="ks-avatar" src="assets/img/avatars/avatar-11.jpg" width="25" height="25">
                                                            </a>
                            ...
                            <div class="ks-projects-grid-board-tasks-body ks-scrollable">
                                <div class="jspPane-padding">
                                    ...
                                    <div class="custom-control custom-checkbox ks-checkbox ks-checkbox-success">
                                        ...
                                        <label class="custom-control-label" for="c7">Make a wireframe</label>
                                    </div>
                                    <div class="custom-control custom-checkbox ks-checkbox ks-checkbox-success">
                                        <input id="c8" type="checkbox" class="custom-control-input">
                                        <label class="custom-control-label" for="c8">Check my new website with all Changes</label>
                                    </div>
                                    <div class="custom-control custom-checkbox ks-checkbox ks-checkbox-success">
                                        <input id="c9" type="checkbox" class="custom-control-input">
                                        <label class="custom-control-label" for="c9">Create login webpage with social login</label>
                                    </div>
                                    <div class="custom-control custom-checkbox ks-checkbox ks-checkbox-success">
                                        <input id="c10" type="checkbox" class="custom-control-input">
                                        <label class="custom-control-label" for="c10">Meeting CEO</label>
                                    </div>
                                    <div class="custom-control custom-checkbox ks-checkbox ks-checkbox-success">
                                        <input id="c11" type="checkbox" class="custom-control-input">
                                        <label class="custom-control-label" for="c11">Create login webpage with social login</label>
                                    </div>
                                    <div class="custom-control custom-checkbox ks-checkbox ks-checkbox-success">
                                        <input id="c12" type="checkbox" class="custom-control-input">
                                        <label class="custom-control-label" for="c12">Make a wireframe</label>
                                    </div>
                                    <div class="custom-control custom-checkbox ks-checkbox ks-checkbox-success">
                                        <input id="c13" type="checkbox" class="custom-control-input">
                                        <label class="custom-control-label" for="c13">Check my new website with all Changes</label>
                                    </div>
                                    <div class="custom-control custom-checkbox ks-checkbox ks-checkbox-success">
                                        <input id="c14" type="checkbox" class="custom-control-input" checked>
                                        <label class="custom-control-label" for="c14">Meeting CEO</label>
                                    </div>
                                    <div class="custom-control custom-checkbox ks-checkbox ks-checkbox-success">
                                        <input id="c15" type="checkbox" class="custom-control-input" checked>
                                        <label class="custom-control-label" for="c15">Create login webpage with social login</label>
                                    </div>
                                    <div class="custom-control custom-checkbox ks-checkbox ks-checkbox-success">
                                        <input id="c16" type="checkbox" class="custom-control-input" checked>
                                        <label class="custom-control-label" for="c16">Make a wireframe</label>
                                    </div>
                                    <div class="custom-control custom-checkbox ks-checkbox ks-checkbox-success">
                                        <input id="c17" type="checkbox" class="custom-control-input" checked>
                                        <label class="custom-control-label" for="c17">Check my new website with all Changes</label>
                                    </div>
                                    <div class="custom-control custom-checkbox ks-checkbox ks-checkbox-success">
                                        <input id="c18" type="checkbox" class="custom-control-input" checked>
                                        <label class="custom-control-label" for="c18">Meeting CEO</label>
                                    </div>
                                </div>
                            </div>
                        </div>
