...
class DeclarationBlockTest extends \PHPUnit_Framework_TestCase {
	...
	public function expandFontShorthandProvider() {
		return array(
			...
			array(
				...
				'body {font-style: normal;font-variant: normal;font-weight: normal; line-height: normal;font-family: serif;}'
			),
			array(
				'body {font: italic 12px serif;}',
				'body {font-style: italic;font-variant: normal;font-weight: normal; line-height: normal;font-family: serif;}'
			),
			array(
				'body {font: italic bold 12px serif;}',
				'body {font-style: italic;font-variant: normal;font-weight: bold; line-height: normal;font-family: serif;}'
			),
			array(
				'body {font: italic bold 12px/1.6 serif;}',
				'body {font-style: italic;font-variant: normal;font-weight: bold; line-height: 1.6;font-family: serif;}'
			),
			array(
				'body {font: italic small-caps bold 12px/1.6 serif;}',
				'body {font-style: italic;font-variant: small-caps;font-weight: bold; line-height: 1.6;font-family: serif;}'
			),
		);
	}
	...
	public function createFontShorthandProvider() {
		return array(
			array('body {  font-family: serif}', 'body {font: 12px serif;}'),
			array('body {  font-family: serif; font-style: italic;}', 'body {font: italic 12px serif;}'),
			array('body {  font-family: serif; font-style: italic; font-weight: bold;}', 'body {font: italic bold 12px serif;}'),
			array('body {  font-family: serif; font-style: italic; font-weight: bold; line-height: 1.6;}', 'body {font: italic bold 12px/1.6 serif;}'),
			array('body {  font-family: serif; font-style: italic; font-weight: bold; line-height: 1.6; font-variant: small-caps;}', 'body {font: italic small-caps bold 12px/1.6 serif;}'),
			array('body {margin: 1em;}', 'body {margin: 1em;}')
		);
	}
